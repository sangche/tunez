defmodule TunezWeb.AuthOverrides do
  ...
  #   set :label_class, "text-gray-700"
  #   set :input_class, "border border-gray-300 rounded px-3 py-2 w-full"
  #   set :error_class, "text-red-500 text-sm mt-1"
  #   set :submit_class, "bg-primary-600 text-white rounded my-4 py-3 px-5 text-sm"
  # end
